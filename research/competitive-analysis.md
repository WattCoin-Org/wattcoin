...
| **Ocean Protocol** | OCEAN | ETH/ASI | $173M | Data Economy | Data NFTs/Datatokens |
| **Golem** | GLM | ETH | $350M | Shared Compute | P2P CPU/GPU Marketplace |
| **Arweave** | AR | Arweave | $1.22B | AI Data Storage | Permanent Permaweb |

*Note: Market cap figures are approximate based on DexScreener/Coingecko data at timestamp.*
...
*   **Tokenomics**: DataTokens and Data NFTs represent ownership/access rights. OCEAN token is being merged into ASI (FET) but remains tradable as a utility proxy.
